...
export default async function AdminInquiryDetailPage({
 ...
 <div className="mt-3 border border-hairline bg-white p-5 sm:p-6">
 <div className="flex flex-wrap items-center gap-2">
 <span className="border border-hairline px-2.5 py-1 text-[10.5px] font-bold uppercase tracking-[0.08em] text-ink-soft">
 ...
 <div className="mt-4 border border-hairline bg-white p-5 sm:p-6">
