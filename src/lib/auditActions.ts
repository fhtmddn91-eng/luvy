...
export const AUDIT_ACTIONS = {
  ...
  ASSET_ADD: "상품 이미지 추가",
  ASSET_DELETE: "상품 이미지 삭제",
  ASSET_KIND: "이미지 자리 변경",
...
export const AUDIT_GROUPS: { key: string; label: string; actions: AuditAction[] }[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      "PAYMENT_UNCERTAIN", "PAYMENT_STRAY_REFUNDED", "PAYMENT_PARTIAL_CANCEL",
    ],
  },
  {
    key: "product",
    ...
    actions: [
      ...
      "ASSET_KIND", "ASSET_TRANSLATE", "CATEGORY_CREATE", "CATEGORY_DELETE",
    ],
  },
  {
    key: "system",
